...
var create_spaces = async function (warehouse_width, warehouse_length, warehouse_id){
    ...
    var sql = "INSERT Into Space (idspace, idwarehouse, price, dimension_width_inches, dimension_height_inches, dimension_length_inches, is_available, is_road, row, col) VALUES?";
    var inter_string = "["
    var ret = [];
    for (var col = 1; col <= col_limit; col++){
        for (var row = 1; row <= row_limit; row++){
            ...
            var temp = [];
            temp.push(idspace, idwarehouse, price, dimension_width_inches, dimension_height_inches, dimension_length_inches, is_available, is_road, row, col);
            ...
            var posting_string_space = "[" + idspace + "," + idwarehouse + "," + price + "," + dimension_width_inches +
                ...
                "," + row + "," + col + "]";
            inter_string += posting_string_space;
            ret.push(temp);
